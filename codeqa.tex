...
For documentation and comments we have adopted a 79 character limit as a compromise between the 72 characters specified in PEP\,8 and our standard code limit.
